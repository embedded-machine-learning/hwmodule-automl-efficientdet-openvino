# Training and Inference of AutoML EfficientDet on OpenVino with EML Tools
...
In ```init_env_tf2oda```, adapt the following part to your venv folder or conda implementation.
